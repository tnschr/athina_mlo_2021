 ...
 * @author Thanos
 */
public class foititis_login extends javax.swing.JFrame {
    ...
    private void foititis_login_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_foititis_login_buttonActionPerformed
        ...
        try {
            ...
            String query="SELECT * FROM foititis WHERE am='"+username_field.getText()+"' AND password='"+password_field.getText()+"'";
            ...
            if(set.next())
            {
                ...
                foititis_panel fp = new foititis_panel(username_field.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(foititis_login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new foititis_login().setVisible(true);
            }
        });
    }
